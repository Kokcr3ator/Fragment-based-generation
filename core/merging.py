...
def graph_to_smiles(graph: nx.Graph) -> str:
    ...
    mol = Chem.rdmolops.GetMolFromAdjacencyMatrix(adj)
...
class Molecule:
    ...
    def merge_fragments(self, fragment_1: int, fragment_2: int) -> nx.Graph:
        """
    ...
    def extract_fragments(self) -> List[nx.Graph]:
        """
        Reduce the graph as much as possible by merging all fragments into one and
        returns the list of all fragments generated by the merging process.

...
class MolGraph(object):
    ...
    @classmethod
    def load_operations(cls, operation_path: str = config.sequencing_config['operation_path'] , num_operations: int = config.sequencing_config['num_operations']):
    ...
    @classmethod
    def load_vocab(cls, vocab_path:str = config.sequencing_config['vocab_path']):
